...
export const NextMatchCard: React.FC<NextMatchCardProps> = ({
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl border border-zinc-800 bg-gradient-to-b from-zinc-900/90 to-zinc-950 p-6 shadow-2xl backdrop-blur-xl sm:p-8">
      ...
      {/* Top Bar: Week and Match Countdown */}
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-zinc-800/80 pb-5">
        ...
        {/* Kickoff Countdown */}
        <div className="flex items-center gap-2 rounded-xl bg-zinc-950/80 px-3.5 py-1.5 border border-zinc-800 text-xs">
      ...
      <div className="mt-6 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
        ...
        <div className="flex flex-wrap items-center gap-3">
          <button
            ...
            className="flex items-center gap-2 rounded-xl border border-zinc-700 bg-zinc-800/80 px-4 py-2.5 text-sm font-semibold text-white hover:bg-zinc-700 transition shadow-sm"
          >
          ...
          <button
            onClick={onGoToPoll}
            className="flex items-center gap-2 rounded-xl bg-emerald-600 px-5 py-2.5 text-sm font-bold text-white hover:bg-emerald-500 transition shadow-lg shadow-emerald-950/50"
          >
            <span>RSVP Now</span>
      ...
      <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {/* Field & Pitch Info */}
        <div className="rounded-2xl border border-zinc-800 bg-zinc-950/60 p-4 transition hover:border-zinc-700">
          ...
          {activeMatch.subwayInfo && (
            <div className="mt-3 flex items-start gap-1.5 text-xs text-zinc-400 border-t border-zinc-800/80 pt-2">
              <Train className="h-3.5 w-3.5 text-emerald-400 shrink-0 mt-0.5" />
        ...
        <div className="rounded-2xl border border-zinc-800 bg-zinc-950/60 p-4 transition hover:border-zinc-700 sm:col-span-2 lg:col-span-1">
          ...
          <div className="mt-3 text-[11px] text-zinc-400 border-t border-zinc-800/80 pt-2 flex items-center justify-between">
            <span>Late responses trigger sub outreach.</span>
            <button
              onClick={onGoToPoll}
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          {!matchMetrics.isReady && (
            <div className="shrink-0 flex items-center">
              <button
                onClick={onGoToSubs}
                className="w-full sm:w-auto flex items-center justify-center gap-2 rounded-xl bg-amber-500 px-4 py-2.5 text-sm font-bold text-zinc-950 hover:bg-amber-400 transition shadow-lg shadow-amber-950/40"
              >
